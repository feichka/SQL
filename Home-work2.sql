...
/* 4.Выберите все заказы. В зависимости от поля order_status выведите столбец
full_order_status:
...
INSERT INTO users (login, pass, male) VALUES (' ', ' ', 1);
...
FROM posts P, users U
WHERE U.id = P.user_id AND u.login = 'Mikle';